...
```{r eval=F, include=F}
preliminaryCAT_items_used <- as.vector(which(apply(raw_responses, 2, function(x) any(!is.na(x)))))
save(preliminaryCAT_items_used, file="Data/preliminaryCAT_items_used")
```
