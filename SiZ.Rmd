...
```{r eval=F}
prepare_input_files(params, cdi_r, fscores_aggr, question = "Czy Twoje dziecko mówi", group = "mowa", file1 = "items-WS.csv", file2 = "startThetas-WS.csv")
```
